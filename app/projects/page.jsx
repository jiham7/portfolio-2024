...
const page = async () => {
  ...
  const data = await fetchData("https://6zmy2apr.api.sanity.io/v2022-03-07/data/query/production?query=*%5B_type+%3D%3D+%22project%22%5D%7B%0A++title%2C%0A++++image%2C%0A++++description%2C%0A++++slug%2C%0A++++details%0A%7D")
